...
public class RedBlackTree{
    ...
    */
    public RedBlackNode treeMinimum (RedBlackTree T, RedBlackNode x){
        if (x == null)
           return x;
        while (x.left != null){
            x = x.left;
    ...
    */
    public RedBlackNode searchKeyHelper (RedBlackTree T, int key, RedBlackNode current){
        ...
        if (current.key == key)
            ...
            return T.searchKeyHelper(T, key, current.left);
        else    
           return T.searchKeyHelper(T, key,current.right);      
    }
    ...
    */
    public Boolean searchKey (RedBlackTree T, int key){
        ...
        RedBlackNode temp = T.searchKeyHelper(T, key, current);
        if (temp == null)
            return false;
        else       
            return true;
    ...
    public void print_tree1_helper (RedBlackNode node, int level){
        if (node != null) {
            print_tree1_helper(node.left, level+1);
